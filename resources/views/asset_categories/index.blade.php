                ...
                <table class="table table-striped ">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('asset_categories.email') }}</th>
                            <th>{{ trans('asset_categories.password') }}</th>
                            <th>{{ trans('asset_categories.remember_token') }}</th>
                    ...
                    @foreach($assetCategories as $assetCategory)
                        <tr>
                            ...
                            <td>{{ $assetCategory->email }}</td>
                            <td>{{ $assetCategory->password }}</td>
                            <td>{{ $assetCategory->remember_token }}</td>
